 ...
 * You may use and distribute this file in accordance  with the terms of the license.
 *
 * For details, see: 
 */
...
function hasBuffer(value) {
     ...
     */
 function Encrypt(data, nd, key1, key2) {
       // const cl = new NumLab
        ...
        if (data instanceof Uint32Array) {
            ...
            return DirectConvertArray32(UInt32array, nd, key1, key2)
            //} else if (typeof data == ArrayBuffer) {
        } else if (data instanceof ArrayBuffer) {

            return DirectConvertByteArrayBuff(data, nd, key1, key2)

            // return cl.DirectConvertArray8(data, nd, key1, key2)
        } else if (hasBuffer(data)) {

            //return cl.DirectConvertByteArrayBuff(data, nd, key1, key2)

            return DirectConvertArray8(data.buffer, nd, key1, key2)
 ...
 function Decrypt(data, nd, key1, key2) {
       ...
       // const cl = new NumLab
        if (data instanceof Uint32Array) {
            ...
            return DirectConvertArray32(UInt32array, nd, key2, key1)
            //} else if (typeof data == ArrayBuffer) {
        } else if (data instanceof ArrayBuffer) {


            //return cl.DirectConvertByteArrayBuff(data, nd, key2, key1)
            return DirectConvertArray8(data, nd, key2, key1)
